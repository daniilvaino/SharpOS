...
- **`done/stepNN.md`** — разбор завершённых шагов с архитектурой, трассами ошибок, файлами. Последний на сегодня: `done/step171.md` (ELF-наследие вырезано, запуск лаунчера — `LauncherBoot`; время до приглашения и отклик на клавиши, PowerShell вровень с Debian в том же QEMU, сверено с видео). Базовая прошивка проекта собрана в `done/step041..step090` (EH/GC/threading/CoreCLR-host), последующие — bring-up конкретных подсистем.
