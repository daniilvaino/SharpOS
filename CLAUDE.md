...
- **`done/stepNN.md`** — разбор завершённых шагов с архитектурой, трассами ошибок, файлами. Последний на сегодня: `done/step168.md` (замеры: `[perf]`-счётчики ядра, `apps_managed/Bench`, `tools/perf_report.ps1`; часы hosted-яруса по HPET). Базовая прошивка проекта собрана в `done/step041..step090` (EH/GC/threading/CoreCLR-host), последующие — bring-up конкретных подсистем.
