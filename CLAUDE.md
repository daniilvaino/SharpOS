...
- **`done/stepNN.md`** — разбор завершённых шагов с архитектурой, трассами ошибок, файлами. Последний на сегодня: `done/step172.md` (полная батарея на ноутбуке и ПК; порча литерала от аллокатора с sentinel, OOM как в NativeAOT, защита образа прошивкой, диск только по ответу прошивки, C++ catch в CoreCLR заработал впервые; замеры в трёх профилях против Windows/Linux). Базовая прошивка проекта собрана в `done/step041..step090` (EH/GC/threading/CoreCLR-host), последующие — bring-up конкретных подсистем.
