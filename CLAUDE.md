...
- **`done/stepNN.md`** — разбор завершённых шагов с архитектурой, трассами ошибок, файлами. Последний на сегодня: `done/step173.md` (тик 1000 Гц — задачи и эхо клавиш; дорогие сборки на железе были следом переписи, на чистой сессии SharpOS вровень с Windows, кроме исключений ×1.2–1.9 и задач на одном ядре). До него `done/step172.md` — железо ноутбука и ПК, C++ catch в CoreCLR. Базовая прошивка проекта собрана в `done/step041..step090` (EH/GC/threading/CoreCLR-host), последующие — bring-up конкретных подсистем.
