...
| Свои аппаратные прерывания (local APIC, тик 100 Гц) | 🟡 | 🚫 | 🚫 | после снятия UEFI: старый PIC замаскирован, тик свой. Вытеснения нет — планирование кооперативное; устройства опрашиваются, IO-APIC не поднят |
