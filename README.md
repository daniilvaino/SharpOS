...
| LINQ extensions | ✅ | ✅ | ✅ | `System.Linq.Enumerable` mini-LINQ (step 134; в PE-аппах — step 141). Source — `List<T>` / итератор / string / массив (массивы честно `IEnumerable<T>` с step 142 — порт `Array<T>`, limits §4) |
