...
gcc -c './obj/{4}/freestanding/app_bootstrap.c' -o './obj/{4}/freestanding/app_bootstrap.o';
gcc -c './obj/{4}/freestanding/runtime_stubs.c' -o './obj/{4}/freestanding/runtime_stubs.o';
ld -o '{1}/{3}' -e SharpAppBootstrap './obj/{4}/freestanding/app_bootstrap.o' '{1}/{2}.a' './obj/{4}/freestanding/runtime_stubs.o' './obj/{4}/freestanding/security_cookie.o';
