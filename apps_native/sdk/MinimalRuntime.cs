...
namespace System.Runtime.InteropServices
{
    ...
    // Declared so that host-platform source compiles; it does not make such a
    // call work. A P/Invoke that survives into a real build fails at link time,
    // which is correct — there is no kernel32 here to bind to.
...
namespace System.Runtime.CompilerServices
{
    ...
    // Same targets as upstream, and as the kernel's copy. Vector128<T> carries
    // it on the TYPE, which is how ILC knows the struct is a machine register
