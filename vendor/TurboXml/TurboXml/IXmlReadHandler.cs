...
//
// SharpOS cut: the default method bodies are gone — this runtime does not
// declare support for default interface implementations, and claiming it to
// keep eleven empty bodies would assert a dispatch capability nobody here has
// verified. A handler implements every member; the ones it does not care about
// are one line each. See PROVENANCE.md.
