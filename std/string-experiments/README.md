...
Выход:
- `std/string-experiments/results/latest.md`
- `std/string-experiments/results/logs/testXX.log`
...
Выход:
- `std/string-experiments/results/runtime-latest.md`
- `std/string-experiments/results/runtime-logs/testXX.build.log`
- `std/string-experiments/results/runtime-logs/testXX.run.log`
